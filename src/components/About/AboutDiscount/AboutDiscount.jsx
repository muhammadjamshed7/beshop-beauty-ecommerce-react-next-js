      ...
      >
        <div className='wrapper'>
          <div className='discount-info'>
            ...
            <h2>SWL develops its own brands</h2>
            <p>
              The SWLe network is being developed and improved, taking into
            ...
            <p className='discount-info__sm'>
              ...
              and care. SWLe stores offer their customers the widest and
